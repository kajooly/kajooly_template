...
#config :kajooly_template, KajoolyTemplateWeb.Endpoint, cache_static_manifest: "priv/static/cache_manifest.json"
...
base_domain = System.get_env("BASE_DOMAIN") ||
  ...
  originslist = [
    "//*.herokuapp.com",
    "//*.kajoolytemplate.#{base_domain}",
    "//*.#{base_domain}"
    ]

config :kajooly_template, KajoolyTemplateWeb.Endpoint,
  url: [host: "kajoolytemplate.#{base_domain}", port: 4000],
